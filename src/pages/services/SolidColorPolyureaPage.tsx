...
const SolidColorPolyureaPage: React.FC = () => {
  const benefits = [
  ...
  return (
    <>
      <Helmet>
        <title>Solid Color Polyurea Flooring | Terra Nuova</title>
        <meta name="description" content="Fast-curing, durable polyurea floors ideal for NYC shops, warehouses & garages. Installed with precision by Terra Nuova." />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 relative">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                <div className="w-16 h-16 md:w-20 md:h-20 bg-gradient-to-r from-green-600 to-emerald-500 rounded-full flex items-center justify-center mx-auto lg:mx-0 mb-6 md:mb-8">
                  <Zap className="w-8 h-8 md:w-10 md:h-10 text-white" />
                </div>
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-black text-[#0066CC] mb-4 md:mb-6 leading-tight">Solid Color Polyurea</h1>
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="relative overflow-hidden rounded-2xl shadow-2xl max-w-lg w-full">
                  <img 
                    src="/images/solid-color-polyurea/process-diagram.png"
                    alt="Solid Color Polyurea Process Diagram"
              ...
              {images.map((src, i) => (
                <div key={i} className="group">
                  <div className="relative overflow-hidden rounded-2xl shadow-lg">
                    <img 
                      src={src}
                      alt={`Solid Color Polyurea project ${i + 1}`}
        ...
        <section className="py-16 md:py-20 px-4 md:px-6 bg-gradient-to-r from-[#0066CC] to-red-600 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-lg md:text-xl mb-6 md:mb-8 opacity-90">Get a free estimate for your solid color polyurea project today.</p>
            <Link 
              to="/contact"
...
export default SolidColorPolyureaPage;