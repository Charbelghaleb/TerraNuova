...
const MetallicSystemPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Metallic Epoxy Floors NYC | Terra Nuova</title>
        <meta name="description" content="Sleek, modern metallic epoxy floors with 3D effects. Perfect for showrooms, basements, retail & more. Free consultations." />
      </Helmet>
